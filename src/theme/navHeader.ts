 ...
 *  иначе уезжает под кнопку «назад». До задачи 72 число 64 стояло копиями в шести местах: пяти
 *  экранах (`lesson/[id]`, `moon`, `paywall`, `review`, `card/[id]`) и общем `SpreadScreen`
 *  (оба маршрута расклада — play и view). */
