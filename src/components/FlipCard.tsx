 ...
 *  флеш-карты тренажёра (ReviewFlashcard, спека 45).
 *
 *  ⚠️ Карта дня на экране «Карта дня» (app/daily.tsx) сюда НЕ переведена, и это решение, а не
 *  недосмотр (хвост 45б закрыт 21.08, обоснование — design-system §5 «Переворотов в приложении
 *  ДВА»): там переворот сцеплен с покачиванием внутри тех же worklet-стилей, идёт 850 мс, держит
 *  обе грани смонтированными и ведёт соседние анимации. Общее у двух реализаций — не код, а
 *  ПРАВИЛО 3D-контекста ниже; меняешь его здесь — проверь и `app/daily.tsx`.
 *
 *  Механика: две грани, rotateY 0→180 / 180→360,
