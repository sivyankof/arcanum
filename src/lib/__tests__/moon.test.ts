 ...
 *  Реальные отклонения верной реализации — не больше 0.5 мин, поэтому 2 минуты дают четырёхкратный
 *  запас честной точности и при этом краснеют на инверсии знака. Правило проекта: тест, который
