...
/** CSS-дефолт `ease` (кривая Безье 0.25/0.1/0.25/1) — общая точка правды для мест, которые сверены
 *  с этой же кривой в design-reference.html (блик карты дня, отъезд игры «Угадай карту»): раньше
 *  каждое место заводило свою константу `EASE` с тем же значением (задача 72, находка F17). */
export const CSS_EASE = Easing.bezier(0.25, 0.1, 0.25, 1);
