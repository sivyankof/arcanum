  ...
  ru: {
    translation: {
      ...
      card: {
        ...
        backProfile: "Профиль", backSpread: "Расклад", backReview: "Тренажёр", backCollection: "Коллекция", todayHighlight: "Ваша карта сегодня",
  ...
  en: {
    translation: {
      ...
      card: {
        ...
        backProfile: "Profile", backSpread: "Spread", backReview: "Trainer", backCollection: "Collection", todayHighlight: "Your card today",
