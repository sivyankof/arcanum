  ...
  ru: {
    translation: {
      ...
      today: {
        ...
        // подписи экрана карты дня, раньше стоявшие тернаром lang === 'ru' мимо i18n (спека 27, раздел З)
        tapToReveal: "НАЖМИ, ЧТОБЫ ПЕРЕВЕРНУТЬ",
        meaning: "ЗНАЧЕНИЕ КАРТЫ",
        continue: "ИЗУЧИТЬ КАРТУ →",
      ...
      // главный учебный экран «Учёба» (спека 72): сводка следующего урока/повторения и карта дня
      home: {
        title: "Учёба",
        lessonOf: "МОДУЛЬ {{m}} · УРОК {{n}} ИЗ {{total}}",
        ctaStart: "НАЧАТЬ УРОК",
        ctaContinue: "ПРОДОЛЖИТЬ КУРС",
        ctaPremium: "ОТКРЫТЬ PREMIUM",
        ctaReview: "К ТРЕНАЖЁРУ",
        courseDone: "Курс пройден",
        dailyHint: "Одна карта в день — так колода запоминается сама",
        dailyDrawn: "Карта дня · открыта",
        dailyReflect: "Вечерний вопрос к карте ждёт",
      },
      // игра «Угадай карту по фрагменту» (спека 72, раздел 10): вход с «Учёбы» и «Практики»
      game: {
        overline: "ИГРА",
        title: "Угадай карту",
        sub: "Узнайте аркан по детали рисунка",
      ...
      card: {
        ...
        keywords: "Ключевые слова", soon: "Текст готовится", backAll: "Карты", backToday: "Карта дня",
      ...
      ob: {
        ...
        howTitle: "Как устроен курс",
        how1: "32 урока по пять минут — от устройства колоды до раскладов",
        how2: "После каждого урока — короткая викторина",
        how3: "Тренажёр сам напомнит, какие карты пора повторить",
        toCourse: "К ПЕРВОМУ УРОКУ",
        nameLabel: "ИМЯ",
      ...
      paywall: {
        ...
        legal: "Подписка продлевается автоматически, пока вы её не отмените в настройках {{store}} — не позже чем за сутки до конца периода.",
        ...
        restoreNoneText: "У этого аккаунта {{store}} нет активной подписки Arcanum Premium.",
      },
  ...
  en: {
    translation: {
      ...
      today: {
        ...
        continue: "STUDY THIS CARD →",
        streakDays_one: "{{count}} day", streakDays_other: "{{count}} days",
      },
      home: {
        title: "Learn",
        lessonOf: "MODULE {{m}} · LESSON {{n}} OF {{total}}",
        ctaStart: "START LESSON",
        ctaContinue: "CONTINUE THE COURSE",
        ctaPremium: "UNLOCK PREMIUM",
        ctaReview: "GO TO THE TRAINER",
        courseDone: "Course complete",
        dailyHint: "One card a day — the deck sticks on its own",
        dailyDrawn: "Card of the day · flipped",
        dailyReflect: "Your evening question is waiting",
      },
      game: {
        overline: "GAME",
        title: "Guess the Card",
        sub: "Name the arcana from a detail of its art",
        question: "Which card is this?",
        resultLine: "{{right}} OF {{total}} CORRECT",
        again: "Play again",
      },
      moon: {
      ...
      card: {
        ...
        keywords: "Keywords", soon: "Text in progress", backAll: "Cards", backToday: "Card of the Day",
      ...
      ob: {
        ...
        howTitle: "How the course works",
        how1: "32 five-minute lessons — from how the deck is built to spreads",
        how2: "A short quiz after every lesson",
        how3: "The trainer reminds you which cards are due for review",
        toCourse: "TO THE FIRST LESSON",
        nameLabel: "NAME",
      ...
      paywall: {
        ...
        legal: "The subscription renews automatically until you cancel it in your {{store}} settings — at least 24 hours before the end of the period.",
        ...
        restoreNoneText: "This {{store}} account has no active Arcanum Premium subscription.",
      },
      feedback: {
  ...
  es: {
    translation: {
      ...
      today: {
        ...
        tapToReveal: "TOCA PARA GIRAR",
        meaning: "SIGNIFICADO DE LA CARTA",
        continue: "ESTUDIAR LA CARTA →",
        streakDays_one: "{{count}} día",
        streakDays_other: "{{count}} días",
      },
      home: {
        title: "Aprender",
        lessonOf: "MÓDULO {{m}} · LECCIÓN {{n}} DE {{total}}",
        ctaStart: "EMPEZAR LA LECCIÓN",
        ctaContinue: "CONTINUAR EL CURSO",
        ctaPremium: "DESBLOQUEAR PREMIUM",
        ctaReview: "IR AL ENTRENADOR",
        courseDone: "Curso completado",
        dailyHint: "Una carta al día: así la baraja se aprende sola",
        dailyDrawn: "Carta del día · abierta",
        dailyReflect: "Tu pregunta de la noche te espera",
      },
      game: {
        overline: "JUEGO",
        title: "Adivina la carta",
        sub: "Reconoce el arcano por un detalle del dibujo",
        question: "¿Qué carta es?",
        resultLine: "{{right}} DE {{total}} CORRECTAS",
        again: "Otra vez",
      },
      moon: {
        new: "Luna nueva",
      ...
      ob: {
        ...
        howTitle: "Cómo funciona el curso",
        how1: "32 lecciones de cinco minutos: de la estructura de la baraja a las tiradas",
        how2: "Un breve cuestionario después de cada lección",
        how3: "El entrenador te recuerda qué cartas toca repasar",
        toCourse: "A LA PRIMERA LECCIÓN",
        nameLabel: "NOMBRE",
      ...
      paywall: {
        ...
        legal: "La suscripción se renueva automáticamente hasta que la canceles en los ajustes de {{store}}, al menos 24 horas antes de que termine el periodo.",
        ...
        restoreNoneText: "Esta cuenta de {{store}} no tiene una suscripción activa de Arcanum Premium.",
      },
      feedback: {
      ...
      review: {
        ...
        toCourse: "AL CURSO",
        toLearn: "VOLVER A LAS LECCIONES",
      },
    },
  },
  ...
  pt: {
    translation: {
      ...
      today: {
        ...
        tapToReveal: "TOQUE PARA VIRAR",
        meaning: "SIGNIFICADO DA CARTA",
        continue: "ESTUDAR A CARTA →",
      ...
      home: {
        ...
        lessonOf: "MÓDULO {{m}} · AULA {{n}} DE {{total}}",
        ctaStart: "COMEÇAR A AULA",
        ctaContinue: "CONTINUAR O CURSO",
        ctaPremium: "DESBLOQUEAR PREMIUM",
        ctaReview: "IR PARA O TREINO",
        courseDone: "Curso concluído",
        dailyHint: "Uma carta por dia — assim o baralho se fixa sozinho",
        dailyDrawn: "Carta do dia · aberta",
        dailyReflect: "Sua pergunta da noite está esperando",
      },
      game: {
        overline: "JOGO",
        title: "Adivinhe a carta",
        sub: "Reconheça o arcano por um detalhe do desenho",
        question: "Que carta é esta?",
        resultLine: "{{right}} DE {{total}} CORRETAS",
        again: "De novo",
      },
      moon: {
        new: "Lua nova",
      ...
      settings: {
        ...
        pushHint: "Também avisamos se sua ofensiva estiver em risco — e uma vez só, se você ficar um tempo sem aparecer",
        ...
        importConfirmText: "Backup de {{date}}. Registros do diário: {{entries}}, ofensiva: {{streak}}. Os dados atuais serão substituídos.",
        importConfirm: "Restaurar",
        importCancel: "Cancelar",
      ...
      paywall: {
        overline: "ASSINATURA",
        title: "Arcanum Premium",
        subtitle: "O curso inteiro, todas as tiragens e o treino sem limite. O guia, a carta do dia e o diário continuam grátis para sempre",
        b1: "O curso completo: 6 módulos, 32 aulas",
        b2: "Todas as tiragens: 9, incluindo a Cruz Celta e a tiragem de lua cheia",
        b3: "Treino sem limite: quantas revisões quiser por dia",
        ...
        restore: "Restaurar compras",
        legal: "A assinatura é renovada automaticamente até que você a cancele nas configurações da loja ({{store}}), pelo menos 24 horas antes do fim do período.",
        ...
        restoreNoneText: "Esta conta da loja ({{store}}) não tem uma assinatura ativa do Arcanum Premium.",
      },
      feedback: {
      ...
      push: {
        ...
        titleStreak_one: "Ofensiva de {{count}} dia",
        titleStreak_other: "Ofensiva de {{count}} dias",
