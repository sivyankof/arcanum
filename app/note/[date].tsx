/** Экран заметки к карте дня (спека 05). Один экран на три входа: плашка на карте дня
 *  (app/daily.tsx), долгий тап по сегодняшней записи дневника и — после задачи 06 — поле рефлексии.
 *
 *  Ввод вынесен с карты дня сюда, потому что на устройстве клавиатура перекрывает поле
  ...
  return (
    <View style={{ flex: 1, backgroundColor: t.bg }}>
      {/* headerBackButtonMenuEnabled: false — тот же гейт useLeaveGuard, что у расклада: модалка
          презентуется поверх ТОГО ЖЕ стека (previousDescriptor у неё есть — карта дня/карточка/
