    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        ...
        <Stack.Protected guard={onboarded}>
          ...
          {/* лунный календарь (спека 47): корневой стек поверх таба «Практика», прозрачная шапка
              с подписью «Практика» на кнопке назад (ставит сам экран; спека 72); объявлен здесь,
              чтобы не пройти мимо гарда онбординга (урок 09 — незаявленный файловый маршрут
              роутер добавляет сам) */}
