  ...
  const header = (
    <>
      ...
      <FadeUp index={2} style={[st.stats, st.pad]}>
        {/* огонёк — иконкой, как в StatsPills (на «Учёбе» и на карте дня): эмодзи из макета рядом
            с иконочным огоньком той же серии выглядел бы вторым, чужим (правка по лайв-проверке) */}
