...
export default function DailyScreen() {
  ...
  // ⚠️ Это ВТОРАЯ реализация переворота в приложении, сознательно не сведённая с общим `FlipCard`
  // (хвост 45б закрыт 21.08, обоснование — design-system §5 «Переворотов в приложении ДВА»):
  // здесь переворот сцеплен с покачиванием в тех же worklet-стилях, идёт 850 мс, держит обе грани
  // смонтированными и ведёт соседние анимации (подпись, значение, блик). Общее — не код, а правило
  // 3D-контекста ниже; правишь его тут — проверь и `src/components/FlipCard.tsx`.
    ...
    <View style={{ flex: 1, backgroundColor: t.bg }}>
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          ...
          requestPermission()
            .catch((err) => {
              console.warn('[daily] не удалось запросить разрешение на пуши:', err);
            })
